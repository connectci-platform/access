...
/**
 * Defines an OpenApi Schema Generator for ACCESS Events API.
 *
 * @OpenApiGenerator(
 *   id = "access_events",
 *   label = @Translation("ACCESS Events API v2.2"),
 * )
 */
class AccessEventsGenerator extends OpenApiGeneratorBase {

  /**
   * {@inheritdoc}
   */
  public function getApiName() {
    return 'ACCESS Events API v2.2';
  }
  ...
  protected function getApiDescription() {
    return 'The ACCESS Events API provides access to upcoming and past events, trainings, webinars, and office hours.';
  }
  ...
  public function getSpecification() {
    ...
    $spec_file = DRUPAL_ROOT . '/modules/custom/access/openapi/events-api-2.2-openapi.yaml';
